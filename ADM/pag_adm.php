...
<body>
    ...
    <section>
        <div id="tabela_visul">
            ...
            <!-- Links para outras funcionalidades, mas sem permitir edição -->
            <a href="Agendamento/index.html"><button>Deseja marcar algum horário?</button></a>
            <a href="testChat/index.php"><button>Teste Chat</button></a>
            <br>
            <br>
